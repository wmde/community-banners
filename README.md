...
This project bundles all assets and dependencies of WMDE community campaign banners with webpack.

If you are an external developer please read the [Developer Guide](DEVELOPER%20GUIDE.md).
